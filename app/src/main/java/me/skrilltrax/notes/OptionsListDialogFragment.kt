...
class OptionsListDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        list.adapter = OptionsAdapter(arguments?.getInt(ARG_ITEM_COUNT) ?: 0)
    }
    ...
    interface Listener {
        fun onOptionsClicked(position: Int)
    }

    private inner class ViewHolder internal constructor(inflater: LayoutInflater, parent: ViewGroup) :
        RecyclerView.ViewHolder(inflater.inflate(R.layout.fragment_options_list_dialog_item, parent, false)) {
        ...
        init {
            text.setOnClickListener {
                mListener?.let {
                    it.onOptionsClicked(adapterPosition)
                    dismiss()
                }
            }
        }
    ...
    private inner class OptionsAdapter internal constructor(private val mItemCount: Int) :
    ...
    companion object {
        ...
        fun newInstance(itemCount: Int): OptionsListDialogFragment =
